const
     ...
     {encounters}
     wildchance     =    15;       {% chance per square to encounter.}
     roadchance     =    5;        {% chance per square on the road.}
     dungeonchance  =    30;       {% chance per square in the dungeon.}
...
type
     ...
     stage          =    (ring,dragon,dilvish,baltar,key,unlocked,endgame);  {keep endgame as the last enum type}
